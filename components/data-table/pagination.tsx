...
export function DataTablePagination<TData>({
  ...
  // Prevent hydration mismatch: force disabled buttons during SSR
  const [hydrated, setHydrated] = useState(false);
  useEffect(() => { setHydrated(true); }, []);
  const canPrev = hydrated ? table.getCanPreviousPage() : false;
  const canNext = hydrated ? table.getCanNextPage() : false;
